...
class ReportGenerator(ABC):
    def __init__(self):
        self.llm = OpenAI(api_key=os.getenv("OPENAI_API_KEY"), max_tokens=2000, temperature=0.3)
...
class CEOReportGenerator(ReportGenerator):
    def generate_report_content(self, data: Dict) -> Presentation:
        ...
        prompt = PromptTemplate(
            ...
            - Integrate compelling visuals (e.g., charts, graphs) to support key points and drive decision-making.
            - All the content should be formatted in Markdown
...
class COOReportGenerator(ReportGenerator):
    def generate_report_content(self, data: Dict) -> Presentation:
        prompt = PromptTemplate(
            ...
            - Integrate visuals such as performance dashboards, flowcharts, or comparative tables to clearly communicate operational insights.
